...
class SimpleConvNet(nn.Module):
    ...
    def __init__(self, input_shape=(32, 32), num_classes=100):
        ...
        layers = []
        # 2 convs
        layers.append(nn.Conv2d(3, 6, kernel_size=2, stride=1))
        layers.append(nn.ReLU(inplace=True))
        layers.append(nn.MaxPool2d(kernel_size=2, stride=2))
        layers.append(nn.BatchNorm2d(6))
        layers.append(nn.Conv2d(6, 16, kernel_size=2, stride=1))
        layers.append(nn.ReLU(inplace=True))
        layers.append(nn.MaxPool2d(kernel_size=2, stride=1))
        layers.append(nn.BatchNorm2d(16))
        layers.append(nn.Conv2d(16, 32, kernel_size=2, stride=1))
        layers.append(nn.ReLU(inplace=True))
        layers.append(nn.BatchNorm2d(32))
        layers.append(nn.Conv2d(32, 64, kernel_size=2, stride=1))
        layers.append(nn.ReLU(inplace=True))
        layers.append(nn.BatchNorm2d(64))
        layers.append(nn.Conv2d(64, 128, kernel_size=2, stride=1))
        layers.append(nn.ReLU(inplace=True))
        layers.append(nn.MaxPool2d(kernel_size=2, stride=1))
        layers.append(nn.BatchNorm2d(128))
        layers.append(nn.Conv2d(128, 256, kernel_size=2, stride=1))
        layers.append(nn.ReLU(inplace=True))
        layers.append(nn.MaxPool2d(kernel_size=2, stride=2))
