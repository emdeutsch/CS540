...
def display_image(orig, proj):
    ...
    plt.subplot(1, 2, 1)
    plt.title("Original")
    orig_colorbar_info = plt.imshow(orig, aspect='equal', cmap='gray')
    plt.colorbar(orig_colorbar_info)
    plt.subplot(1, 2, 2)
    plt.title("Projection")
    proj_colorbar_info = plt.imshow(proj, aspect='equal', cmap='gray')
    plt.colorbar(proj_colorbar_info)
    plt.show()